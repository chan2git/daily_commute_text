...
def get_commute_duration():
    google_api = "AIzaSyDQW8rGBSsJkL_mYAV3iaStlkCUXb7mJVA" # Replace with your Google Maps API key
    ...
    start_addr = "298 E Main St, Middletown, DE 19709"
    end_addr = "4755 Ogletown Stanton Rd, Newark, DE 19718"
...
def send_text_message(message):
    ...
    twilio_account_sid = "AC0956ff5687e7e843b9d076f8a5f109de"
    twilio_account_token = "5cb3cb1646aa0863dc7beb20ca3bbb5e"
    twilio_phone_num = "18773568513"

    # Defines the recipient's phone number (format: "1##########"")
    recipient_phone_num = "13025138778"
